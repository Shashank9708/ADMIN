...
class VideoAppointments extends React.Component {
    /**
    ...
    */
    getAppointmentsList(page, pageSize, sorted, filtered){
        const { dispatch }   = this.props;
        dispatch(appointmentActions.getVideoAppointmentList(page, pageSize, sorted, filtered));
    }
                      ...
                      <main role="main" className="col-md-9 ml-sm-auto col-lg-10 px-md-4">
                          <div className="page-heading">
                            <div className="page-heading__title-container">
                                <h1 className="page-heading__title">Video Appointments</h1>
                            </div>
                          </div>
                          <div className="row">
                              <ReactTable
...
const connectedVideoAppointments = connect(mapStateToProps)(VideoAppointments);
export { connectedVideoAppointments as VideoAppointments };
