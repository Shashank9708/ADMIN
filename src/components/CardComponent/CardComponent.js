  ...
  function CardComponent() {
    ...
    <>
      ...
      <div className="card-header bg-ark">
        <div className="card-header__name">Chetan Wagh</div>
      </div>
      <div className="card-body">
        <div className="card-body__profile-with-user-details">
          <div className="card-body__profile-with-user-details__profile">
            <img className="card-profile-image" src="https://www.michiganlutheran.org/wp-content/uploads/2019/09/placeholder-profile-sq.jpg" />
          </div>    
      ...
      <div className="card-footer bg-transparent">
        ...
        <div className="card-footer__status-value">
          <span className="card-footer__booked">Booked</span>
        </div>
      </div>
      </div>
    </>
