              ...
              <div>
                <Modal show={props.addHealthTipsShow} onHide={props.handleClose}>
                      ...
                      <div className="row">
                        ...
                        <div className="col-md-12">
                          <div className='form-group'>
                            <input name="author_name" value={props.payload.detail.author_name} type="text" className="form-control" onChange = { props.handleInputChange } placeholder="Author Name"/>
                          </div>
                        </div>

                        <div className="col-md-12">
                          <div className={ props.payload.validate.title.isValid ? 'form-group' : 'form-group has-error' }>
                            <input name="title" type="text" value={props.payload.detail.title} className="form-control" onChange = { props.handleInputChange } placeholder="Title"/>
                        ...
                        <div className="col-md-12">
                          <div className={ props.payload.validate.desc_en.isValid ? 'form-group' : 'form-group has-error' }>
                            <textarea name="desc_en" value={props.payload.detail.desc_en} className="form-control" onChange = { props.handleInputChange } placeholder="Description"></textarea>
                  ...
                  <Modal.Footer>
                    ...
                    <Button className="btn-sm" onClick={props.handleSaveHealthTips}>Save</Button>
                  </Modal.Footer>
                </Modal>
              </div>
      );
