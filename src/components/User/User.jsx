                                  ...
                                  <ReactTable
                                      ...
                                      columns={[
                                              ...
                                              Cell: row => 
                                                          <div>
                                                            <a href="javascript:void(0)" 
                                                              onClick={ this.statusShowHandle.bind(null,row.original.id,row.value) } 
                                                              disabled={ this.props.submitted ? true : false }>
                                                              {
                                                                row.value == 'suspended' ? 
                                                                <span className="btn btn-danger">Suspended</span> : 
                                                                row.value == 'active' ?
                                          ...
                                          },
                                          {
                                              ...
                                              Cell: row => <div>
                                                               <Countdown
                                                                date={this.createDate(row.value)}
                                          ...
                                          },
                                          {
                                              ...
                                              Cell: row => 
                                                          <div>
                                                            ...
                                                            <a href="javascript:void(0)" 
                                                              onClick={ this.reNewShowHandle.bind(null,row.original.id,row.original.package_type) } 
                                                              disabled={ this.props.submitted ? true : false }
                                                              className="btn table-btn btn-info">Renew
                                                            </a>
                                                            <a href="javascript:void(0)" 
