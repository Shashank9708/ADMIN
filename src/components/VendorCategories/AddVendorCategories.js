...
export const AddVendorCategories = (props) => { 
    // console.log('props===>>>',props)
    return (
              <div>
                <Modal show={props.addVendorCategoriesShow} onHide={props.handleClose}>
                  ...
                  <Modal.Footer>
                    ...
                    <Button className="btn text-btn green" onClick={props.handleSaveVendorCategories}>Save</Button>
                  </Modal.Footer>
                </Modal>
              </div>
      );
